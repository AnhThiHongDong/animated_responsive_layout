...
class _EmailContentState extends State<EmailContent> {
  ...
  //   // };
  //   String formatElapsed(Duration elapsedTime) {
  //     if (elapsedTime.inSeconds < 60) {
  //       return '${elapsedTime.inSeconds}s';}
  //     else if (elapsedTime.inMinutes < 60) {
  //       return '${elapsedTime.inMinutes}m';}
  //     else if (elapsedTime.inHours < 24) {
  //       return '${elapsedTime.inHours}h';}
  //     else if (elapsedTime.inDays < 365) {
  //       return '${elapsedTime.inDays}d';}
  ...
  // sanity check: no future times
  if (widget.email.sender.lastActive.isAfter(now)) {
    throw ArgumentError('lastActive cannot be in the future');
  }

  final Duration elapsedTime = now.difference(widget.email.sender.lastActive);

  if (elapsedTime.inSeconds < 60) {
    return '${elapsedTime.inSeconds}s ago';
  } else if (elapsedTime.inMinutes < 60) {
    return '${elapsedTime.inMinutes}m ago';
  } else if (elapsedTime.inHours < 24) {
    return '${elapsedTime.inHours}h ago';
  } else if (elapsedTime.inDays < 365) {
    return '${elapsedTime.inDays}d ago';
  } else {
    return '${elapsedTime.inDays ~/ 365}y ago';
  }
}
  ...
  // ignore: unnecessary_type_check
  if (widget is EmailContent) {
    // ignore: unnecessary_cast
    final content = widget as EmailContent;
    if (content.isThreaded) {
